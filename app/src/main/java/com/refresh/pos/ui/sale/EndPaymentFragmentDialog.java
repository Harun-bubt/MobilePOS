...
public class EndPaymentFragmentDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String discountValue = getArguments().getString("discount");
...
//        String content = edtEditText.getText().toString(); //gets you the contents of edit text
    ...
    private void setPrintDataStore() {
        ...
        if (discount > 0) {
            totalAmt = totalAmt - discount;//(totalAmt + sgst + cgst) - discount;
        }
//        else {
...
//String phone="";
            ...
            final ArrayList<ReceiptProduct> receiptProductArrayList = new ArrayList<>();
            for (final LineItem lineItem : regis.getCurrentSale().getAllLineItem()) {
                ...
                (getActivity()).runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        totalQuantity[0] = totalQuantity[0] + lineItem.getQuantity();
                        par[0] += "&name[]=" + lineItem.getProduct().getName() + "&qty[]=" + lineItem.getQuantity() + "&price[]=" + lineItem.getProduct().getUnitPrice() + "&number[]=" + lineItem.getProduct().getBarcode() + "&phone=" + input + "&discount=" + discount;
...
//        String parameters = "session={'username':'nishammpm@gmail.com','password':'nisham','db':'cre8bill_db1'}"+"&number[]="+number+"&name[]="+name+"&qty[]="+quantity+"&price[]="+price;
            String parameters = par[0] + "&phone=" + input + "&discount=" + discount;
            //String parameters="";
            try {
