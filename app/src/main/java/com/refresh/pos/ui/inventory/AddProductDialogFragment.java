...
public class AddProductDialogFragment extends DialogFragment implements CreAbsActivity {
...
*/
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (nameBox.getText().toString().equals("")
                    ...
                    productCatalog.addProductFromNetwork(nameBox.getText().toString(),
                            barcodeBox.getText().toString(), priceBox.getText().toString(),
                            Quantity.getText().toString(), AddProductDialogFragment.this);
                }
            }
        });
    ...
    public int onRequestSuccess(String code, String msg) {
        try {
            ...
            String sales_price = jsonObject.getString("sales_price");

            boolean success = productCatalog.addProduct(id, item_name, item_code, sales_price);

            if (success) {
                Toast.makeText(getActivity().getBaseContext(),
                        res.getString(R.string.success) + ", "
                                + item_name, Toast.LENGTH_SHORT).show();
                new LoginAsyncTask(item_code, item_name, quantity, sales_price).execute();
            ...
            Log.e("AddProductDialog", "onRequestSuccess " + e.getLocalizedMessage());
        }
    ...
    private class LoginAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        public LoginAsyncTask(String number, String name, String quantity, String price) {
            this.number = number;
            this.name = name;
...
*/
            String parameters = "session={'username':'nishammpm@gmail.com','password':'nisham','db':'cre8bill_db1'}"
                    + "&number=" + number + "&name=" + name + "&qty=" + quantity + "&price=" + price;
            //String parameters="";
            try {
