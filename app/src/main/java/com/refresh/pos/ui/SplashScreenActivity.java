...
import com.refresh.pos.techicalservices.inventory.InventoryDaoNetwork;
import com.refresh.pos.techicalservices.sale.SaleDao;
import com.refresh.pos.techicalservices.sale.SaleDaoAndroid;
import com.refresh.pos.techicalservices.sale.SaleDaoNetwork;
...
//		InventoryDao inventoryDao = new InventoryDaoAndroid(database);
		InventoryDao inventoryDao = new InventoryDaoNetwork(database);
//		SaleDao saleDao = new SaleDaoAndroid(database);
		SaleDao saleDao = new SaleDaoNetwork(database);
